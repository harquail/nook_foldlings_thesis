...
in the toolbar at the bottom of the sketch. In general, all features are
defined by dragging in the drawing area. Features are generally
...
\ref{interface-data-structures}, \nameref{interface-data-structures}, on
page \pageref{interface-data-structures}. What follows is a description
...
``print''. This option provides what is essentially a screenshot of the
2D sketch. This image can be printed, emailed, or shared via social
media. Typically, this is the option a user would choose to cut and fold
their design by hand.
