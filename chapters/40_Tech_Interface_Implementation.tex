...
\ref{feature-interactions} \nameref{feature-interactions} on page
...
driving fold)\footnote{A description of truncation can be found in
  ...
  \nameref{tool-implementation} on page \pageref{tool-implementation}}.
...
When the user completes a feature, we add it to the sketch\footnote{Assuming
  ...
  \nameref{validity} on page \pageref{validity}.}. Adding a feature to
...
in section \ref{tool-implementation} \nameref{tool-implementation} on
