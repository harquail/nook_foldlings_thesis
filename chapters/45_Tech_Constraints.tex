...
there is a trade. We adjusted the line pattern to consist of short dots
spaced out slightly further than the minimum edge distance. While we
discovered the line pattern through experimentation, it performs well on
multiple laser cutters, paper types, and manual cutting. This fold
pattern should work for virtually all paper cutting methods.
