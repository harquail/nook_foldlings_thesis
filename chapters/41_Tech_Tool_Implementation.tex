...
\paragraph{Geometric Contraints}\label{geometric-contraints}

talk about fold heights talk about occlusion

\subsubsection{FreeForm}\label{freeform}

\paragraph{Geometric Contraints}\label{geometric-contraints-1}
...
\paragraph{Geometric Contraints}\label{geometric-contraints-2}

contrast with free-form talk about point dragging talk about truncation

\subsubsection{V-Fold}\label{v-fold}

\paragraph{Geometric Contraints}\label{geometric-contraints-3}
